...
class Publication extends Model
{
    ...
    public function files() {
      return $this->belongsToMany('App\Models\File','publications_file');
    }
    ...
    public function getShortTitleAttribute()
  {
      ...
      return mb_strimwidth($this->{$column}, 0, 80, "...");
  }
    ...
    public function getImageAttribute()
    {
        ...
        return "/images/publications/" . $locale ."/". $this->{$column};
    }
    ...
    public function getPdfAttribute()
    {
        $locale = App::getLocale();
        $column = "pdf_" . $locale;
        return "/files/publications/" . $locale ."/". $this->{$column};
    }
