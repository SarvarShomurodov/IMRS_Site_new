              ...
              <div class="row align-items-center">
                  <div class="col-sm-6">
                      ...
                      <ol class="breadcrumb">
                          ...
                          <li class="breadcrumb-item active">{{$archive->title_ru}}</li>
                      </ol>
                  </div>
                  <div class="col-sm-6">
          ...
          <div class="col-12">
              <div class="card">
                  <div class="card-body">
                      ...
                      <form class="needs-validation" action="/admin/archives/edit/{{$archive->id}}" method="post">
                        @csrf
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Заголовок (uz)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="title_uz"  type="text" value="{{$archive->title_uz}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Заголовок (ru)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="title_ru"  type="text" value="{{$archive->title_ru}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Заголовок (en)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="title_en"  type="text" value="{{$archive->title_en}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input class="form-control" name="slug"  type="text" value="{{$archive->slug}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input class="form-control" name="meta_description_uz"  type="text" value="{{$archive->meta_description_uz}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Meta Description (ru)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="meta_description_ru"  type="text" value="{{$archive->meta_description_ru}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Meta Description (en)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="meta_description_en"  type="text" value="{{$archive->meta_description_en}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Meta Keywords (uz)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="meta_keywords_uz"  type="text" value="{{$archive->meta_keywords_uz}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Meta Keywords (ru)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="meta_keywords_ru"  type="text" value="{{$archive->meta_keywords_ru}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Meta Keywords (en)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="meta_keywords_en"  type="text" value="{{$archive->meta_keywords_en}}" required>
                            </div>
                        </div>
