                  ...
                  <div class="card-body">
                      ...
                      <div class="table-responsive">
                          <table class="table mb-0">
                              ...
                              <tbody>
                                @php $number = ($archives->currentPage()-1)*20; @endphp
                                @foreach($archives as $archive)
                                  <tr>
                                      ...
                                      <td>{{$archive->slug}}</td>
                                      <td>
                                        <a href="/admin/archives/edit/{{$archive->id}}" class="text-success mr-4" data-toggle="tooltip" data-placement="top" title="" data-original-title="Изменить"> <i class="dripicons-pencil h5 m-0"></i></a>
                                        <a href="javascript:" onclick="deleteArchive(this)" rel="/admin/archives/delete/{{$archive->id}}" class="text-danger" data-toggle="modal" data-target="#myModal" data-placement="top" title="" data-original-title="Удалить" aria-describedby="tooltip934720"> <i class="dripicons-cross h5 m-0"></i></a>
