          ...
          <div class="col-12">
              <div class="card">
                  <div class="card-body">
                      ...
                      <form class="needs-validation" action="/admin/news/edit/{{$item->id}}" method="post" enctype='multipart/form-data'>
                        @csrf
                        ...
                        <div class="form-group">
                            <label>Фото (uz)</label>
                            <img src="/images/news/uz/{{$item->image_uz}}" alt="" width="300">
                        ...
                        <div class="form-group">
                            <label>Фото (ru)</label>
                            <img src="/images/news/ru/{{$item->image_ru}}" alt="" width="300">
                        ...
                        <div class="form-group">
                            <label>Фото (en)</label>
                            <img src="/images/news/en/{{$item->image_en}}" alt="" width="300">
                        ...
                        <div class="form-group">
                            <label>pdf (uz)</label>
                            <object data="/files/news/uz/{{$item->pdf_uz}}" type="application/pdf" width="580" height="300">
                        ...
                        <div class="form-group">
                            <label>pdf (ru)</label>
                            <object data="/files/news/ru/{{$item->pdf_ru}}" type="application/pdf" width="580" height="300">
                        ...
                        <div class="form-group">
                            <label>pdf (en)</label>
                            <object data="/files/news/en/{{$item->pdf_en}}" type="application/pdf" width="580" height="300">
                        ...
                        @foreach($item->files as $file)
                          ...
                          <div class="" style="display: flex;  align-items:center">
                            ...
                            @elseif($name[1]=='doc' || $name[1]=='docx')
                              <a href="/files/files/{{$file->file}}">{{$file->file}}</a>
                            @endif
                            <a href="{{route('admin.file.delete', ['news', $item->id, $file->id])}}" style="" class="btn btn-danger waves-effect waves-light" name="button">Удалить</a>
                          </div>
                          <br>
                        @endforeach
                        <div class="form-group mb-0">
