          ...
          <div class="col-12">
              <div class="card">
                  <div class="card-body">
                      ...
                      <form class="needs-validation" action="/admin/administrations/edit/{{$item->id}}" method="post" enctype='multipart/form-data'>
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input class="form-control" name="name_uz"  type="text" value="{{$item->name_uz}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Ф.И.О (ru)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="name_ru"  type="text" value="{{$item->name_ru}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Ф.И.О (en)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="name_en"  type="text" value="{{$item->name_en}}">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group">
                            <label>Фото </label>
                            <img src="/images/administrations/{{$item->image}}" alt="" width="300">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input class="form-control" name="duties_uz"  type="text" value="{{$item->duties_uz}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Обязанности (ru)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="duties_ru"  type="text" value="{{$item->duties_ru}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Обязанности (en)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="duties_en"  type="text" value="{{$item->duties_en}}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Биография (uz)</label>
                            <textarea name="biography_uz" id="description_uz">{!!$item->biography_uz!!}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Биография (ru)</label>
                            <textarea name="biography_ru" id="description_ru">{!!$item->biography_ru!!}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Биография (en)</label>
                            <textarea name="biography_en" id="description_en">{!!$item->biography_en!!}</textarea>
                        </div>
                        <input type="hidden" value="no" name="vacant" >
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox" value="yes" name="vacant" @if($item->vacant=='yes') checked @endif id="vacant">
