              ...
              <div class="row align-items-center">
                  <div class="col-sm-6">
                      ...
                      <ol class="breadcrumb">
                          ...
                          <li class="breadcrumb-item active">Добавить закон</li>
                      </ol>
                  </div>
                  <div class="col-sm-6">
          ...
          <div class="col-12">
              <div class="card">
                  <div class="card-body">
                      ...
                      <form class="needs-validation" action="/admin/laws/create" method="post">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input class="form-control" name="slug_uz"  type="text" value="{{old('slug_uz')}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-6 col-form-label">URL (ru)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="slug_ru"  type="text" value="{{old('slug_ru')}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-6 col-form-label">URL (en)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="slug_en"  type="text" value="{{old('slug_en')}}">
                            </div>
                        </div>
