              ...
              <div class="row align-items-center">
                  <div class="col-sm-6">
                      ...
                      <ol class="breadcrumb">
                          ...
                          <li class="breadcrumb-item"><a href="/admin/publications/categories">Категории публикаций</a></li>
          ...
          <div class="col-12">
              <div class="card">
                  <div class="card-body">
                      ...
                      <form class="needs-validation" action="/admin/publications/categories/edit/{{$item->id}}" method="post" enctype='multipart/form-data'>
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2 select2-hidden-accessible" data-select2-id="1" tabindex="-1" aria-hidden="true" name="parent_id">
                                    <option  value="" style="color: #888">--------Без родительского раздела--------</option>
                                    @foreach($categories as $category)
                                        <option value="{{$category->id}}" @if($category->id == $item->parent_id) selected @endif @if($category->parent()->exists()) disabled @endif>@if($category->parent()->exists()) -- @endif{{$category->title_ru}}</option>
                                    @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            <label>Фото</label>
                            <br>
                            <img src="/images/publicationcategories/{{$item->image}}" alt="" width="300px">
