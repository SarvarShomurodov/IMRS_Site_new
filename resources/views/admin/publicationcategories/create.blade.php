          ...
          <div class="col-12">
              <div class="card">
                  <div class="card-body">
                      ...
                      <form class="needs-validation" action="/admin/publications/categories/create" method="post" enctype='multipart/form-data'>
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2 select2-hidden-accessible" data-select2-id="1" tabindex="-1" aria-hidden="true" name="parent_id">
                                    ...
                                    @foreach($categories as $category)
                                        <option value="{{$category->id}}" @if($category->parent()->exists()) disabled @endif>@if($category->parent()->exists()) -- @endif{{$category->title_ru}}</option>
                                    @endforeach
                            </select>
                        </div>
                        <div class="form-group">
