  ...
  <div class="content">
              ...
              <div class="row align-items-center">
                  <div class="col-sm-6">
                      ...
                      <ol class="breadcrumb">
                          ...
                          <li class="breadcrumb-item active">{{$item->time_ru}}</li>
                      </ol>
                  </div>
                  <div class="col-sm-6">
      ...
      <div class="row">
          <div class="col-12">
              <div class="card">
                  <div class="card-body">
                      <h4 class="mt-0 header-title">{{$item->time_ru}}</h4>
                      <br><br><br>

                      <form class="needs-validation" action="/admin/journals/edit/{{$item->id}}" method="post" enctype='multipart/form-data'>
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <img src="/images/journals/{{$item->image}}" alt="" width="400">
                        ...
                        <div class="form-group">
                            <label>Журнал</label>
                            <object data="/files/journals/{{$item->journal}}" type="application/pdf" width="680" height="300">
                              <a href="/files/journals/{{$item->journal}}">{{$item->journal}}</a>
                            </object>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input class="form-control" name="time_uz"  type="text" value="{{$item->time_uz}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Выпуск (ru)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="time_ru"  type="text" value="{{$item->time_ru}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Выпуск (en)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="time_en"  type="text" value="{{$item->time_en}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input class="form-control" name="sort" type="number" min="0" step="1" value="{{ old('sort', $item->sort ?? 0) }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input class="form-control" name="editorial_staff_uz"  type="text" value="{{$item->editorial_staff_uz}}" >
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Редакция (ru)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="editorial_staff_ru"  type="text" value="{{$item->editorial_staff_ru}}" >
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Редакция (en)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="editorial_staff_en"  type="text" value="{{$item->editorial_staff_en}}" >
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input class="form-control" name="editorial_board_uz"  type="text" value="{{$item->editorial_board_uz}}" >
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Редакционная коллегия (ru)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="editorial_board_ru"  type="text" value="{{$item->editorial_board_ru}}" >
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Редакционная коллегия (en)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="editorial_board_en"  type="text" value="{{$item->editorial_board_en}}" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="submission_uz" id="submission_uz">{!!$item->submission_uz!!}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Требования к статье (ru)</label>
                            <textarea name="submission_ru" id="submission_ru">{!!$item->submission_ru!!}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Требования к статье (en)</label>
                            <textarea name="submission_en" id="submission_en">{!!$item->submission_en!!}</textarea>
                        </div>

                        <div class="form-group">
                            <label>Новости  (uz)</label>
                            <textarea name="news_uz" id="news_uz">{!!$item->news_uz!!}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Новости  (ru)</label>
                            <textarea name="news_ru" id="news_ru">{!!$item->news_ru!!}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Новости  (en)</label>
                            <textarea name="news_en" id="news_en">{!!$item->news_en!!}</textarea>
                        </div>

                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Подписка (uz)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="subscription_uz"  type="text" value="{{$item->subscription_uz}}" >
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Подписка (ru)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="subscription_ru"  type="text" value="{{$item->subscription_ru}}" >
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Подписка (en)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="subscription_en"  type="text" value="{{$item->subscription_en}}" >
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input class="form-control" name="contacts_uz"  type="text" value="{{$item->contacts_uz}}" >
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Контакты (ru)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="contacts_ru"  type="text" value="{{$item->contacts_ru}}" >
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Контакты (en)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="contacts_en"  type="text" value="{{$item->contacts_en}}" >
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input class="form-control" name="issn"  type="text" value="{{$item->issn}}" >
                            </div>
                        </div>
