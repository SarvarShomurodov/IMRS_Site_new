      ...
      <div class="container-fluid">
          <div class="page-title-box">
              <div class="row align-items-center">
                  <div class="col-sm-6">
                      <h4 class="page-title">Категории публикаций</h4>
                      <ol class="breadcrumb">
                          <li class="breadcrumb-item"><a href="/admin"><i class="mdi mdi-home-outline"></i></a></li>
                          <li class="breadcrumb-item"><a href="/admin/pages-categories">Категории публикаций</a></li>
                  ...
                  <div class="col-sm-6">
                      <div class="float-right d-none d-md-block">
                          <div class="dropdown">
                              <a class="btn btn-primary dropdown-toggle arrow-none waves-effect waves-light text-white" href="/admin/pages-categories/create">
          ...
          <div class="col-12">
              <div class="card">
                  <div class="card-body">
                      ...
                      <form class="needs-validation" action="/admin/pages-categories/create" method="post" enctype='multipart/form-data'>
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input class="form-control" name="meta_description_uz"  type="text" value="{{old('meta_description_uz')}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Meta Description (ru)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="meta_description_ru"  type="text" value="{{old('meta_description_ru')}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Meta Description (en)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="meta_description_en"  type="text" value="{{old('meta_description_en')}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Meta Keywords (uz)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="meta_keywords_uz"  type="text" value="{{old('meta_keywords_uz')}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Meta Keywords (ru)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="meta_keywords_ru"  type="text" value="{{old('meta_keywords_ru')}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Meta Keywords (en)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="meta_keywords_en"  type="text" value="{{old('meta_keywords_en')}}">
                            </div>
                        </div>
