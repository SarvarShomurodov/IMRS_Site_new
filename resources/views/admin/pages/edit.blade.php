          ...
          <div class="col-12">
              <div class="card">
                  <div class="card-body">
                      ...
                      <form class="needs-validation" action="/admin/pages/edit/{{$item->id}}" method="post" enctype='multipart/form-data'>
                        @csrf
                        ...
                        <div class="form-group">
                            <label>Фото (uz)</label>
                            <img src="/images/pages/uz/{{$item->image_uz}}" alt="" width="300">
                        ...
                        <div class="form-group">
                            <label>Фото (ru)</label>
                            <img src="/images/pages/ru/{{$item->image_ru}}" alt="" width="300">
                        ...
                        <div class="form-group">
                            <label>Фото (en)</label>
                            <img src="/images/pages/en/{{$item->image_en}}" alt="" width="300">
                        ...
                        <div class="form-group">
                            <label>pdf (uz)</label>
                            <object data="/files/pages/uz/{{$item->pdf_uz}}" type="application/pdf" width="580" height="300">
                              <a href="/files/pages/uz/{{$item->pdf_uz}}">{{$item->pdf_uz}}</a>
                            </object>
                        ...
                        <div class="form-group">
                            <label>pdf (ru)</label>
                            <object data="/files/pages/ru/{{$item->pdf_ru}}" type="application/pdf" width="580" height="300">
                        ...
                        <div class="form-group">
                            <label>pdf (en)</label>
                            <object data="/files/pages/en/{{$item->pdf_en}}" type="application/pdf" width="580" height="300">
                              <a href="/files/pages/en/{{$item->pdf_en}}">{{$item->pdf_ru}}</a>
                            </object>
