              ...
              <div class="row align-items-center">
                  <div class="col-sm-6">
                      ...
                      <ol class="breadcrumb">
                          ...
                          <li class="breadcrumb-item active">{{$item->name_ru}}</li>
                      </ol>
                  </div>
                  <div class="col-sm-6">
          ...
          <div class="col-12">
              <div class="card">
                  <div class="card-body">
                      ...
                      <form class="needs-validation" action="/admin/scolars/edit/{{$item->id}}" method="post" enctype='multipart/form-data'>
                        @csrf
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Имя (uz)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="name_uz"  type="text" value="{{$item->name_uz}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Имя (ru)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="name_ru"  type="text" value="{{$item->name_ru}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Имя (en)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="name_en"  type="text" value="{{$item->name_en}}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Фото</label>
                            <img src="/images/scholars/{{$item->image}}" alt="">
                        ...
                        <div class="form-group">
                            <label>Тема (uz)</label>
                            <textarea name="theme_uz" id="theme_uz">{!!$item->theme_uz!!}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Тема (ru)</label>
                            <textarea name="theme_ru" id="theme_ru">{!!$item->theme_ru!!}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Тема (en)</label>
                            <textarea name="theme_en" id="theme_en">{!!$item->theme_en!!}</textarea>
                        </div>

                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">PhD/DSc (uz)</label>
                            <div class="col-sm-12">
                              <input class="form-control" name="phddsc_uz"  type="text" value="{{$item->phddsc_uz}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">PhD/DSc (ru)</label>
                            <div class="col-sm-12">
                              <input class="form-control" name="phddsc_ru"  type="text" value="{{$item->phddsc_ru}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">PhD/DSc (en)</label>
                            <div class="col-sm-12">
                              <input class="form-control" name="phddsc_en"  type="text" value="{{$item->phddsc_en}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input class="form-control" name="place_uz"  type="text" value="{{$item->place_uz}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Место защиты (ru)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="place_ru"  type="text" value="{{$item->place_ru}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Место защиты (en)</label>
                            <div class="col-sm-12">
                                <input class="form-control" name="place_en"  type="text" value="{{$item->place_en}}">
                            </div>
                        </div>
                        <div class="form-group row">
