                  ...
                  <div class="entry-content">
                    @if($item->issetDescription())
                      ...
                      @if($item->issetPdf())
                      	...
                      	<h4>
                          <strong>
                            <a href="{{$item->getPdfAttribute()}}">@lang('index.example')</a>
                          </strong>
                        </h4>
                      	@else
                      	<h4>	
                          <strong>
                            <a href="{{$item->getPdfAttribute()}}">@lang('index.download')</a>
                          </strong>
                        </h4>
                      	@endif
              ...
              <nav class="navigation post-navigation" role="navigation" aria-label="Записи">
                ...
                @if($item1)
                  <div class="nav-links"><div class="nav-previous">
                    <a href="{{route('page', [$item1->slug])}}" rel="prev">
                ...
                <br>
                  <div class="nav-next">
                    <a href="{{route('page', [$item2->slug])}}" rel="next">
