...
@php
  ...
  if ($path === '' || $path === '/') {
    ...
    elseif ($pageCat === $pagesWebinarSlug)                      $activeNav = 'webinars';
            ...
            str_starts_with($path, 'employees') || str_starts_with($path, 'laws/') ||
            str_starts_with($path, 'korrupsiyaga') || str_starts_with($path, 'p/history')) {
    $activeNav = 'about';
...
<header id="hdr" role="banner">
  <div class="container">
    <nav class="nav-wrap" aria-label="@lang('site.main_nav')">
      ...
      <ul class="nav-links" role="list">
        <li class="nav-item has-sub">
          ...
          <div class="dropdown" role="menu">
            ...
            <div class="dropdown-title">@lang('site.legal_base')</div>
      ...
      <div class="nav-right">
        <div class="lang-sw" role="group" aria-label="@lang('site.lang_select')">
          <a href="{{ route('changelocale', 'uz') }}" class="lang-btn @if($loc==='uz') act @endif">UZ</a>
          <a href="{{ route('changelocale', 'ru') }}" class="lang-btn @if($loc==='ru') act @endif">RU</a>
          <a href="{{ route('changelocale', 'en') }}" class="lang-btn @if($loc==='en') act @endif">EN</a>
        </div>
